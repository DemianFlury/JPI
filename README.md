# JPI - The API for Jokes

This is intended as a small Project where I learn how to make a REST API in Java Spring Boot
The API can tell you a random Joke depending on a category you choose. You should also be able to add, edit and delete Jokes from the database using the API.
